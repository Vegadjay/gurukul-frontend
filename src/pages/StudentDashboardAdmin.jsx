...
const StudentDashboard = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-900 font-poppins">
            <div className="w-full mx-auto px-8 md:px-12 lg:px-16 pt-8 mt-10">
                <button
                    onClick={handleBackButton}
                    className="flex items-center text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 text-xl font-medium transition-colors"
                >
            ...
            {/* Main content */}
            <main className="w-full mx-auto px-8 md:px-12 lg:px-16 py-8 font-poppins">
                {/* Tabs */}
                <div className="mb-10 border-b-4 border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <nav className="flex space-x-12">
                        ...
                        <button
                            ...
                            className={`py-6 px-4 font-medium text-2xl border-b-4 font-poppins ${activeTab === "courses"
                                ? "border-blue-600 text-blue-600"
                                : "border-transparent text-gray-500 hover:border-gray-300"
                                }`}
                        >
                ...
                {activeTab === "courses" && (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                        <div className="p-8 border-b-2 border-gray-200 dark:border-gray-700">
                            <h3 className="text-2xl font-medium text-gray-900 dark:text-white font-poppins">My Enrolled Courses</h3>
                        </div>
                        {enrolledCourses && enrolledCourses.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 p-8">
                                {enrolledCourses.map((course) => (
                                    <div key={course._id} className="bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg">
                                        <div className="h-56 bg-gray-200 dark:bg-gray-600 overflow-hidden">
                                            <img
                                                src={course.courseImage || "https://placehold.co/600x400"}
                                                alt={course.title}
                                                className="w-full h-full object-cover"
                                            />
                                        </div>
                                        <div className="p-8">
                                            <h4 className="text-2xl font-medium text-gray-900 dark:text-white mb-4 font-poppins">{course.title}</h4>
                                            <div className="flex items-center text-lg text-gray-500 dark:text-gray-400 mb-4 font-poppins">
                                                <User className="h-6 w-6 mr-3" />
                                                {course.guruName}
                                            </div>
                                            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-5 mb-3">
                                                <div
                                                    className="bg-blue-600 h-5 rounded-full"
                                                    style={{ width: `${course.progress}%` }}
                                                ></div>
                                            </div>
                                            <div className="flex justify-between text-base text-gray-500 dark:text-gray-400 font-poppins mb-6">
                                                <span>{course.progress}% Complete</span>
                                                <span>{course.lessonsCompleted}/{course.totalLessons} Lessons</span>
                                            </div>
                                            <button className="w-full mt-6 px-6 py-4 bg-blue-600 text-white text-xl rounded-md hover:bg-blue-700 font-poppins">
                                                Continue Learning
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="p-16 text-center">
                                <Book className="mx-auto h-20 w-20 text-gray-400" />
                                <h3 className="mt-6 text-2xl font-medium text-gray-900 dark:text-white font-poppins">Working On It</h3>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                        ...
                        {gurusData && gurusData.length > 0 ? (
                            ...
                            <div className="p-16 text-center">
                                ...
                                <p className="mt-4 text-xl text-gray-500 dark:text-gray-400 font-poppins">
                                    Explore our catalog and enroll with skilled gurus.
                                </p>
                                <Link to="/explore-gurus" className="inline-block mt-8 px-8 py-4 bg-blue-600 text-white text-xl rounded-md hover:bg-blue-700 font-poppins">
                                    Find a Guru
                                </Link>
                            </div>
                        )}
